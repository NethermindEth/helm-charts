...
| execution.jsonrpc.namespaces.reth[4] | string | `"debug"` |  |
...
| image.beacon.lighthouse.repository | string | `"sigp/lighthouse"` |  |
| image.beacon.lighthouse.tag | string | `"v7.1.0"` |  |
| image.beacon.lodestar.repository | string | `"chainsafe/lodestar"` |  |
| image.beacon.lodestar.tag | string | `"v1.34.1"` |  |
| image.beacon.nimbus.repository | string | `"statusim/nimbus-eth2"` |  |
| image.beacon.nimbus.tag | string | `"multiarch-v25.9.2"` |  |
| image.beacon.prysm.repository | string | `"gcr.io/prylabs-dev/prysm/beacon-chain"` |  |
| image.beacon.prysm.tag | string | `"v6.0.5"` |  |
| image.beacon.teku.repository | string | `"consensys/teku"` |  |
| image.beacon.teku.tag | string | `"25.9.3"` |  |
| image.execution.besu.repository | string | `"hyperledger/besu"` |  |
| image.execution.besu.tag | string | `"25.9.0"` |  |
| image.execution.erigon.repository | string | `"erigontech/erigon"` |  |
| image.execution.erigon.tag | string | `"v3.1.0"` |  |
| image.execution.geth.repository | string | `"ethereum/client-go"` |  |
| image.execution.geth.tag | string | `"v1.16.4"` |  |
| image.execution.nethermind.repository | string | `"nethermind/nethermind"` |  |
| image.execution.nethermind.tag | string | `"1.34.0"` |  |
| image.execution.reth.repository | string | `"ghcr.io/paradigmxyz/reth"` |  |
| image.execution.reth.tag | string | `"v1.8.2"` |  |
